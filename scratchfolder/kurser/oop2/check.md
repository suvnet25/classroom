...
Här kan du göra en egenkoll på vad du har koll på just nu och vad du behöver jobba mer på.

<div class="kc-auto" data-kc-scope="oop2-v1" markdown>
...
* Entity Framework
    ...
    * Jag kan förklara skillnaden mellan Code First och Database First i Entity Framework.
    * Jag vet vad syftet med DbContext och DbSet är
    * Jag kan skapa en DbContext och definiera DbSet-egenskaper för mina entiteter. [[Testa]]()
    * Jag kan skapa de tre olika relationstyperna (one-to-one, one-to-many, many-to-many) i Entity Framework. [[Testa]]()
    * Jag kan använda migrations för att uppdatera min databas när jag ändrar mina entiteter. [[Testa]]()
    * Jag kan skriva LINQ-queries mot min DbContext för att hämta data från databasen. [[Testa]]()
    * Jag kan i kod visa skillnaden mellan deferred och immediate execution i LINQ. [[Testa]]()
    * Jag vet skillnaden mellan en IQueryable och en IEnumerable och när man ska använda vilken.
    * Jag kan i kod visa skillanden mellan Eager Loading och Lazy Loading i Entity Framework. [[Testa]]()

* TCP/IP och HTTP
    * Jag kan förklara skillnaden mellan TCP/IP och HTTP.
    * Jag kan förklara hur en HTTP-förfrågan och svar fungerar.
    * Jag kan använda HttpClient i C# för att göra en HTTP-förfrågan. [[Testa]]()
    * Jag kan förklara begreppen HTTP-metod, url, statuskod, headers och body.
    * Jag kan förklara vad GET, POST, PUT och DELETE används till.
    * Jag kan förklara vad ett RESTful API är och vilka principer det följer.
    * Jag kan nämna några viktiga headers och vad de används till.
    * Jag kan ge exempel på olika data som kan skickas i en HTTP-body

* Async, await och Task
    * Jag kan förklara vad asynkron kod är och när det är användbart.
    * Jag kan förklara vad en Task är och hur den används i C#.
    * Jag kan använda async och await för att skriva asynkron kod i C#. [[Testa]]()
    * Jag kan förklara vad en *deadlock* är
